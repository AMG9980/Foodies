...
require $_SERVER['DOCUMENT_ROOT'] ."/Foodies/app/controllers/controller.php";

//on charge le fichier modèle des roles
require $_SERVER['DOCUMENT_ROOT'] ."/Foodies/app/models/tasks.php";
...
class tasks extends Controller {
	...
	public function __construct() {
		...
		//initialisation de la classe modèle des roles
		$this->tasks = new tasksModel();
	}

	private function render() {
		$this->view->render("tasks", [
                "tasks" => $this->tasks->get_tasks() //on récupère la liste des roles de la base de données
            ]
	...
	public function get_tasks() {
		...
		//$this->renderSV(); //on actualise la page
	}
